...
public class InstructionsScreen extends Screen {
    ...
    public void initialize() {
        ...
        instructionsJump = new SpriteFont("To JUMP: UP arrow key, or 'W', or SPACEBAR", 130, 140, "Times New Roman", 20, Color.darkGray);
        instructions2Label = new SpriteFont("To MOVE LEFT: LEFT arrow key, or 'A'", 130, 180, "Times New Roman", 20, Color.darkGray);
        instructions3Label = new SpriteFont("To MOVE RIGHT: RIGHT arrow key, or 'D'", 130, 220, "Times New Roman",20, Color.darkGray);
        instructions4Label = new SpriteFont("To CROUCH: DOWN arrow key, or 'S'", 130,260, "Times New Roman", 20, Color.darkGray);
        instructions5Label = new SpriteFont("To ATTACK: E key", 130, 300, "Times New Roman", 20, Color.darkGray);
        instructions6Label = new SpriteFont("To INTERACT: F key", 130, 340, "Times New Roman", 20, Color.darkGray);
